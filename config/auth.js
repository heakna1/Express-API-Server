...
//*authentification middleware for JavaScript
const bcrypt = require('bcrypt')
//*b is for Blowfish cipher and crypt for the name of the hashing function used by the UNIX password system
const jwt = require('jsonwebtoken')
//*compact way of securely transmitting information between parties

// Create a secret to be used to encrypt/decrypt the token
// This can be any string value you want -- even gibberish.
//process.env.JWT_SECRET => defaults to undefined
const secret = process.env.JWT_SECRET || 'some string value only your app knows'
//*variable that processes the token created for the app
...
//*have to use the authentication strategy and extraction method to get the token
//Stratedy and ExtractJwt are classes
...
const opts = {
	...
	// headers: {
	//"Accept": "app/json",
	// "Authorization": "Bearer djhfskdjhflasdkjfhdlfj"
	//}
...
//*variable that takes the request and extracts the token 

// Require the user model
const User = require('../models/user')
//*creating variable from a specific path
...
const createUserToken = (req, user) => {
	...
	if (
		...
		err.statusCode = 422
		//*Unprocessable Entity - the content type and syntax is correct but its unable to process the instructions */
		throw err
	}
